...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(BNP}\SpecialCharTok{$}\NormalTok{Aar,BNP}\SpecialCharTok{$}\NormalTok{BNP,}\AttributeTok{type=}\StringTok{"l"}\NormalTok{,}\AttributeTok{lty=}\DecValTok{1}\NormalTok{,}\AttributeTok{lwd=}\DecValTok{1}\NormalTok{,}\AttributeTok{xlab=}\StringTok{"År"}\NormalTok{,}
\AttributeTok{ylab=}\StringTok{"BNP"}\NormalTok{,}\AttributeTok{col=}\StringTok{"black"}\NormalTok{,}\AttributeTok{main=}\StringTok{"..."}\NormalTok{,}\AttributeTok{sub=}\StringTok{"Kilde:..."}\NormalTok{)}
