...
plot(Export$Year,Export$X,type="l",lty=1,lwd=1,xlab="År",
     ylab="Export/Import",col="black",main="Import og Eksport",sub="Kilde:Statistikbanken");
...
```{r}
plot(Export$Year,Export$X,type="l",lty=1,lwd=1,xlab="År",
ylab="BNP",col="black",main="Import og Eksport",sub="Kilde:Statistikbanken",ylim=c(100,1300));
...
ylab="BNP",col="black",main="Import og Eksport",sub="Kilde:Statistikbanken",ylim=c(100,1300));
lines(Import$Year,Import$Import,type="l",lty=1,lwd=1,col="red"); 
legend(x=1970,y= 1200,legend=c("Export","Import"),lty=1,lwd=2,
       col=c("Black","Red"),bty="n"); grid()
```
- Forklaring:
...
type="l",col="black", main="BNP og Investeringer");axis(2, ylim=c(600,2300),col="black") 
...
type="l",col="black", main="BNP");axis(2, ylim=c(600,2300),col="black")
```


```{r}
plot(BNP$Year[-1],diff(BNP$BNP), xlim = c(1982,2007), xlab="Year", ylab="BNP", 
type="l",col="black", main="Ændring i BNP");axis(2, ylim=c(600,2300),col="black") 
```
...
```{r}
plot(Employment$Year,Employment$Emp, xlab="Year", ylab="EMP", 
type="l",col="black", main="Beskæftigelse"); grid()
```
...
Vi kan se 2018 har observation 53 og 2020 observation 55
Dermed kan vi sammenligne disse


```{r}
Emp_2018= Employment$Emp[53]
Emp_2020= Employment$Emp[55]
```
